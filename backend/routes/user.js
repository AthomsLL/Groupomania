...
router.put('/:id', passport.authenticate('jwt', { session: false }), auth.me, userCtrl.editUserProfile);
...
router.delete('/:id', passport.authenticate('jwt', { session: false }), auth.adminAndMe, userCtrl.deleteUser);
